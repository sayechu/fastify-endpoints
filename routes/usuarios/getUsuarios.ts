...
import {getUsuariosSchema} from "./getUsuariosSchema";
...
export default async function (fastify: FastifyInstance) {
    fastify.get('/', getUsuariosSchema,
        async function (request: FastifyRequest<{ Querystring: QueryString }>, reply: FastifyReply) {
